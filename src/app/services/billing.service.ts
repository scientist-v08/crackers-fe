...
export class BillingService {
    ...
    public generateBill(req: BillDetailsInterface): Observable<BillResponseInterface> {
    ...
    public finalizedBill(allItems: ItemsInterface[], discount: number): ItemsInterface[] {
